                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-12" data-aos='fade-left' data-aos-offset='200'  data-aos-duration="1000">
                            <div className='banner_text'>
                                ...
                                <h2 className='text-primary mb-4'>Suraj Metal  is well-known Round Bars, Rods, Wire Supplier in India.</h2>
                                <p>Suraj Metal  a leading valve manWe manufacture Round Bars, Rods, Wire for end-user and stockist all over the world. we can also offer Round Bars in Stainless Steel 310/310S and Incoloy 800. On basis of skilled manpower and vast years of experience, Korus Steel has become a well-recognized name among customers worldwide. Product high strength and durability have created Suraj Metal  leading businessperson, manufacturers, and suppliers of Rods & Wire in India. As a leading 310 Stainless Steel Wire supplier, we produce the Wire as per client requirements in different standards and dimensions.</p>
                            </div>
                        </div>
                    </div>
                </div>
