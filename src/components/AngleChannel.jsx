...
import angle1 from '/images/images/angle1.png'
import angle2 from '/images/images/angle2.png'
import angle3 from '/images/images/angle4.png'
import angle4 from '/images/images/angle4.png'
                    ...
                    <div className="row">
                        ...
                        <div className='col-md-9 col-12'>
                            <div className={`angle_channel_description ${scrolling && 'scroll'}`}>
                                ...
                                <p>Ritex Metal Corporation is a well-known and reputed Angle, Channel & Flat Bar manufacturer in India. Our Angle, Channel & Flat Bars are available in different materials such as Hastelloy Angle, Channel, & Flat Bar, Monel Angle, Channel, & Flat Bar, Inconel Angle, Channel, & Flat Bar, Titanium Angle, Channel, & Flat Bar, Alloy 20 Angle, Channel, & Flat Bar. Angle, Channel, & Flat Bar at Ritex Metal Corporation are manufactured according to international standards such as ASTM Standard, ASME Standard, ANSI Standard, EU Standard, DIN Standard, IS Standard, ISO Standard, and JIS Standard in India.</p>
                                <div className="row">
                                    <div className="col-4">
                                        <div className="img">
